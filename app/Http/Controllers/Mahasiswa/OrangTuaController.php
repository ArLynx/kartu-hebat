...
class OrangTuaController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'pekerjaan_ayah' => ['required', 'string', 'max:150'],
            'penghasilan_ayah' => ['required', 'numeric', 'min:0', 'max:9999999999999.99'],
            'nama_ibu' => ['required', 'string', 'max:150'],
            'nik_ibu' => ['nullable', 'digits:16'],
            'pekerjaan_ibu' => ['required', 'string', 'max:150'],
            'penghasilan_ibu' => ['required', 'numeric', 'min:0', 'max:9999999999999.99'],
            'memiliki_wali' => ['required', 'boolean'],
            'nama_wali' => ['nullable', 'required_if:memiliki_wali,1', 'string', 'max:150'],
            'nik_wali' => ['nullable', 'required_if:memiliki_wali,1', 'digits:16'],
            'pekerjaan_wali' => ['nullable', 'required_if:memiliki_wali,1', 'string', 'max:150'],
            'penghasilan_wali' => [
                'nullable',
