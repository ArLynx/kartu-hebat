    ...
    <aside
        ...
        <nav class="mt-10 flex-1 space-y-1.5 overflow-y-auto">
            ...
            @elseif($user->isSuperadmin())
                <x-sidebar-link :href="route('superadmin.dashboard')" :active="request()->routeIs('superadmin.dashboard')" icon="home">
                    Dashboard
                </x-sidebar-link>
                ...
                <x-sidebar-link :href="route('superadmin.document-types.index')" :active="request()->routeIs('superadmin.document-types.*')" icon="document">
                    Document Types
                </x-sidebar-link>

                <x-sidebar-link :href="route('superadmin.operators.index')" :active="request()->routeIs('superadmin.operators.*')" icon="users">
                    Operator
                </x-sidebar-link>

                {{-- Log Aktivitas --}}
                <x-sidebar-link :href="route('superadmin.log-aktivitas.index')" :active="request()->routeIs('superadmin.log-aktivitas.*')" icon="activity">
                    Log Aktivitas
                </x-sidebar-link>
            @else
